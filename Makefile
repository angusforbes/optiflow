...
SRC = flowIO.cpp colorcode.cpp colortest.cpp color_flow.cpp flow_demo.cpp farneback_optical_flow.cpp
BIN = colortest color_flow flow_demo brox_flow brox_optical_flow
...
#farn: farneback_optical_flow.cpp flowIO.cpp colorcode.cpp
brox_optical_flow: brox_optical_flow.cpp
